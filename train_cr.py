...
if __name__ == "__main__":
    ...
    parser.add_argument("--evolve_rank_delay_ratio", type=float, default=0.09, help="Delay rank ratio before training")
    ...
    parser.add_argument("--evolve_anneal_k", type=float, default=7.5e-6, help="Temporal rank-pressure annealing rate")
    ...
    parser.add_argument("--lora_dropout", type=float, default=0.03, help="LoRA dropout value")
    ...
    parser.add_argument("--lr", type=float, default=3.05e-4, help="Learning rate")
