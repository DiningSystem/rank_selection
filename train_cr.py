...
if __name__ == "__main__":
    ...
    parser.add_argument("--evolve_rank_delay_ratio", type=float, default=0.08, help="Delay rank ratio before training")
    parser.add_argument("--evolve_r_min", type=int, default=2, help="Minimum target effective rank for evolve-LoRA")
    parser.add_argument("--evolve_beta", type=float, default=0.018, help="Information-conditioned rank consistency weight")
    parser.add_argument("--evolve_alpha_max", type=float, default=0.003, help="Maximum temporal effective-rank pressure")
    parser.add_argument("--evolve_anneal_k", type=float, default=8e-6, help="Temporal rank-pressure annealing rate")
    parser.add_argument("--evolve_gate_floor", type=float, default=0.13, help="Minimum spectral gate value")
    ...
    parser.add_argument("--lora_dropout", type=float, default=0.02, help="LoRA dropout value")
